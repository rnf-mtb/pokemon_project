...
import com.fra.pokemonproject.model.PokemonStat
import com.fra.pokemonproject.model.PokemonStats

class PokemonStatsListAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private val TAG = "PokemonStatsAdapter"
    private var _pkmnInfoList = mutableListOf<PokemonStats>()
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val info: String = _pkmnInfoList[position].base_stat ?: "n.d."
    ...
    fun setStatsList(info: List<PokemonStats>){
        _pkmnInfoList.clear()
